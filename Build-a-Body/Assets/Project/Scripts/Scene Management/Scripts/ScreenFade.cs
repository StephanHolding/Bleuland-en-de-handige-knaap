...
public class ScreenFade : MonoBehaviour
{
    ...
    internal static event FadeEvent OnFadeInDone;
    internal static event FadeEvent OnFadeOutDone;
    ...
    private void DisableUnusedFadeTypes()
    {
        switch (fadeType)
        {
    ...
    public static void DestroyScreenFadeInstance()
    {
        if (instance != null)
        {
    ...
    private static ScreenFade CreateScreenfadeInstance(Camera cam)
    {
        ...
        newObject.transform.position = cam.transform.TransformPoint(new Vector3(0, 0, cam.nearClipPlane + 0.05f));
    ...
    private static void SetPositionToCamera()
    {
        if (instance != null && targetCam != null)
        {
            instance.transform.position = targetCam.transform.TransformPoint(new Vector3(0, 0, targetCam.nearClipPlane + 0.05f));
        }
    }
}
